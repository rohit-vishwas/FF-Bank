...
contract Tether{
    ...
    function approve(address _spender , uint256 _value) public returns(bool success){
        //msg sender allocates allowance to _spender to spend on his behalf
    ...
    function transfer(address _to ,uint value) public returns(bool success){
        ...
        //user who called, will have money deducted from their accounts
    ...
    function transferFrom(address _from , address _to  , uint _value) public returns(bool success){
        ...
        //checks whether the function caller has the required allowance to send the money
        //from "_from" to some other user
